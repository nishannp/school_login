            ...
            <div class="row">
                ...
                <div class="col-lg-4 col-md-4 mb-4">
                    <div class="footer-links">
                        <h5>Contact Us</h5>
                        <ul>
                            <li><i class="fas fa-map-marker-alt me-2"></i> 123 University Wolverhampton</li>
                            <li><i class="fas fa-phone me-2"></i> (123) 222222</li>
                            <li><i class="fas fa-envelope me-2"></i> campusconnect@gmail.com</li>
                        </ul>
                    </div>
                </div>
            </div>
