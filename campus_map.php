...
while ($row = $events_result->fetch_assoc()) {
    ...
    $events_by_location[$location_key]['events'][] = [
        ...
        'image_url' => $row['image_url'] ?: 'images/default-event.jpg' 
    ];
    ...
    if ($interval->days <= 7 && $current_date <= $event_date) { 
        $upcoming_events[] = $row;
    }
}
$events_stmt->close();
...
if ($user_prefs && $user_prefs['default_map_location']) {
    ...
    $default_zoom = $user_prefs['default_map_zoom'] ?: 13; 
}
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            <?php foreach ($events_by_location as $location_data): ?>
                ...
                markerData.push({
                    ...
                    popupContent: <?php echo json_encode($popup_content); ?>, 
            ...
            markerData.forEach(data => {
                ...
                marker.eventData = data.eventData; 
